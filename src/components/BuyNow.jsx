...
export const BuyNow = () => {
  ...
  },
  {
    ...
    return (
        <div className="px-10">
            <h2 className="mt-32 text-3xl font-medium mb-3">Checkout</h2>

            <div className="flex justify-center gap-10">
                <div className="w-1/3">
                    <h2 className="text-xl font-semibold pl-5">Shipping Address</h2>
                ...
                <div className="w-[25%] bg-gray-300 p-5 h-fit">
                    ...
                    <div className="w-full flex justify-between font-medium text-lg mb-2">
                        <p>Total </p>
